...
class ScanResult:
    ...
    def get_duplicate_groups_by_size(
    ...
    def get_potential_matches_by_extension(
        self, extension: str
    ...
    def get_summary(self) -> Dict[str, any]:
        ...
        summary = {
            ...
            "series_groups_found": getattr(self.metadata, "series_groups_found", 0),
            "total_series_files": len(getattr(self.metadata, "series_groups", [])),
    ...
    def sort_potential_matches_by_similarity(
        ...
        self.potential_match_groups.sort(
            key=lambda group: group.average_similarity, reverse=reverse
        )
