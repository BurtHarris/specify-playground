...
class TestConfigManager:
    ...
    def test_config_path_macos(self, mock_home, mock_system):
        ...
        config_manager = ConfigManager()
        expected_path = Path(
            "/Users/test/Library/Application Support/video-duplicate-scanner/config.yaml"
        )
    ...
    def test_load_config_creates_default_when_missing(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(
                ConfigManager, "_get_config_path", return_value=config_path
            ):
                config_manager = ConfigManager()
    ...
    def test_load_config_merges_with_defaults(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            partial_config = {"fuzzy_threshold": 0.7, "verbose_mode": True}
            ...
            with patch.object(
                ...
                assert (
                    ...
                    == ConfigManager.DEFAULT_CONFIG["large_file_threshold"]
                )
                assert (
                    config["recursive_scan"]
                    == ConfigManager.DEFAULT_CONFIG["recursive_scan"]
                )
    ...
    def test_get_setting(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(
                ...
                assert (
                    config_manager.get_setting("non_existent", "default_value")
                    == "default_value"
                )
